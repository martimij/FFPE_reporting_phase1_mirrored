...
# Working directory where fixed merged VCF will be written
...
vcf_input="/home/mmijuskovic/small_variant_freq/FF/mergedVCF/final_for_production/FF_PCRfree_mainProgram_2017.PASSonly.merged.sorted.vcf.gz"

# List of samples to remove
exclude_samples="/home/mmijuskovic/small_variant_freq/FF/mergedVCF/final_for_production/fixed_for_production/FFPCRfree_to_remove.txt"
