#!/bin/bash
#BSUB -J mergedVCF_index_test_noNorm
#BSUB -n 1
#BSUB -q bio
...
# Create log file
logfile=/home/mmijuskovic/small_variant_freq/allCohortsMergedVCF/test/mergedVCF_index_test_noNorm_log.txt
...
-o /home/mmijuskovic/small_variant_freq/allCohortsMergedVCF/test/cancer_mainProgram_2017.merged.AF.sorted.self_annotation_noNorm.json


# Examine the output json to check if all variants are annotated
echo "Count of AF_FFPE" >> $logfile
grep AF_FFPE /home/mmijuskovic/small_variant_freq/allCohortsMergedVCF/test/cancer_mainProgram_2017.merged.AF.sorted.self_annotation_noNorm.json | wc -l &>> $logfile

echo "Count of AF_FFpcrfree" >> $logfile
grep AF_FFpcrfree /home/mmijuskovic/small_variant_freq/allCohortsMergedVCF/test/cancer_mainProgram_2017.merged.AF.sorted.self_annotation_noNorm.json | wc -l &>> $logfile

echo "Count of AF_FFnano" >> $logfile
grep AF_FFnano /home/mmijuskovic/small_variant_freq/allCohortsMergedVCF/test/cancer_mainProgram_2017.merged.AF.sorted.self_annotation_noNorm.json | wc -l &>> $logfile
