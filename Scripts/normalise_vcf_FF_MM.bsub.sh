...
workdir="/home/mmijuskovic/small_variant_freq/FF/norm_VCFs/"

# Read the CSV input file in the format "sample_name,VCF_path" (30 samples/job)
IFS=","
while read f1 f2
do
        # Read the input line
...
done < /home/mmijuskovic/small_variant_freq/FF/norm_VCFs_input/samples_for_recurrent_calc_normalization_input_${LSB_JOBINDEX}.csv
